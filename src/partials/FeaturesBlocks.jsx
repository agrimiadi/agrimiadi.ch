        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-left text-gray-600">
              Diese Frage wird sich unsere kleine Familie wohl noch einige Male
              fragen, aber was hat sie eigentlich in dieses, für schweizer
              Verhältnisse wilde Tal verschlagen? Würde man Sky fragen, dann
              würde er mit einem bestimmten "Damit wir keine anderen dieser
              miesen Köter mehr treffen müssen" antworten. Denn obwhohl er
              selbst einer ist, kann er andere Hunde auf den Tod nicht
              ausstehen. Die sind die Pest! Schnaubt er wenn er darauf
              angesprochen wird und will nichts mehr von seinen Artgenossen
              hören. Das einzige was er will ist, andere Tiere vor sich
              hertreiben. Am besten den ganzen Tag!
            </p>
            <img
          ...
          {/* Items */}
          <div className="text-white text-xl max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            {/* 1st item */}
            blabla
